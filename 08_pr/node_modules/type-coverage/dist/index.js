...
async function executeCommandLine() {
    ...
    const { atLeast, debug, detail, enableCache, ignoreCatch, ignoreFiles, ignoreUnread, is, project, strict, update, ignoreNested, ignoreAsAssertion, ignoreTypeAssertion, ignoreNonNullAssertion, showRelativePath, historyFile, noDetailWhenFailed, } = await getTarget(argv);
